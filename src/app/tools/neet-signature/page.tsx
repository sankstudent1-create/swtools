...
const TOOL_CONFIG = {
  name: "NEET Signature Formatter",
  org: "NTA NEET UG Upload Module",
  icon: "🧪",
  ...
  conditions: [
    ...
    "File size: 10 to 50 KB",
    "Dimensions: 420 px × 140 px",
    "Aspect ratio: 3:1 landscape",
    "Signature should be dark and legible",
    "Use black ink on white sheet",
    "No digital/typed text",
    "Entire signature must fit without clipping",
  ],
};
...
export default function NeetSignaturePage() {
  ...
  async function onAutoFix() {
    ...
    try {
      ...
      const outputFile = new File([blob], `${file.name.split(".")[0]}-neet-signature.jpg`, { type: TOOL_CONFIG.format });
  ...
  return (
    <main className="min-h-screen">
      <section className="relative overflow-hidden pt-20 pb-16 md:pt-32 md:pb-24">
        <div className="absolute inset-0 -z-10 bg-gradient-to-br from-emerald-400/15 via-brand-orange/5 to-transparent" />
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-4 pt-4">
              ...
              <div className={`p-4 rounded-xl border ${TOOL_CONFIG.colorBorder} ${TOOL_CONFIG.colorBg}`}>
                ...
                <p className={`text-xl font-bold ${TOOL_CONFIG.colorText}`}>3:1 Landscape</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 md:py-16">
        <div className="mx-auto max-w-4xl px-4 md:px-6">
          <div className="ui-modal-shell overflow-hidden">
            ...
            <span className="ui-ambient-orb bottom-6 left-4 h-16 w-16 bg-brand-orange/20" />
              ...
              <div className="relative z-10 space-y-6">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <h2 className="font-heading text-2xl font-bold">Upload NEET Signature</h2>
                  </div>
                </div>
      ...
      <SuccessPopup
        ...
        title="NEET Signature Processed"
        message="Your NEET signature is now optimized for fast and compliant upload submission."
        onClose={() => setShowSuccess(false)}
        onDownload={onDownloadProcessed}
        downloadLabel="Download NEET Signature"
      />
    </main>
  );
}
