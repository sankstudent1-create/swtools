...
const TOOL_CONFIG = {
  ...
  org: "SBI / IBPS Banking Recruitment",
  icon: "👆",
  ...
  conditions: [
    ...
    "File size: 20 to 50 KB",
    "Dimensions: 240 px × 240 px",
    "Aspect ratio: 1:1 square",
    "Left thumb impression in blue ink preferred",
    "Scan on clean white background",
    "Thumb lines should be clear and visible",
    "No blur, shadows, or cropped edges",
  ],
};
...
export default function BankThumbPage() {
  ...
  async function onAutoFix() {
    ...
    try {
      ...
      const outputFile = new File([blob], `${file.name.split(".")[0]}-bank-thumb.jpg`, { type: TOOL_CONFIG.format });
  ...
  return (
    <main className="min-h-screen">
      <section className="relative overflow-hidden pt-20 pb-16 md:pt-32 md:pb-24">
        <div className="absolute inset-0 -z-10 bg-gradient-to-br from-violet-500/15 via-brand-pink/5 to-transparent" />
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-4 pt-4">
              ...
              <div className={`p-4 rounded-xl border ${TOOL_CONFIG.colorBorder} ${TOOL_CONFIG.colorBg}`}>
                ...
                <p className={`text-xl font-bold ${TOOL_CONFIG.colorText}`}>1:1 Square</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 md:py-16">
        <div className="mx-auto max-w-4xl px-4 md:px-6">
          <div className="ui-modal-shell overflow-hidden">
            <span className="ui-ambient-orb right-5 top-5 h-20 w-20 bg-violet-500/30" />
              ...
              <div className="relative z-10 space-y-6">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <h2 className="font-heading text-2xl font-bold">Upload Thumb Impression</h2>
                  </div>
                </div>
      ...
      <SuccessPopup
        ...
        title="Thumb Impression Processed"
        message="Your banking thumb impression is now portal-ready with balanced size and clear contrast."
        onClose={() => setShowSuccess(false)}
        onDownload={onDownloadProcessed}
        downloadLabel="Download Thumb File"
      />
    </main>
  );
}
