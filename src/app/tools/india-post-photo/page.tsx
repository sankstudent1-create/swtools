...
const TOOL_CONFIG = {
  ...
  conditions: [
    ...
    "File size: 30 to 100 KB",
    "Dimensions: 320 px (W) × 400 px (H)",
    ...
    "Face coverage: 70-80% of image area",
    "No shadows, red-eye, or facial distortions",
    "Recently taken photo, clear and front-facing",
    "No sunglasses, hats, or head coverings",
    "Professional appearance, natural expression",
  ],
};
...
function calculateValidation(
  ...
  if (!isRatioValid) messages.push(`Aspect ratio should be ${(targetRatio).toFixed(3)} (4:5).`);
...
export default function IndiaPostPhotoPage() {
  ...
  async function onAutoFix() {
    ...
    try {
      ...
      const outputFile = new File([blob], `${file.name.split(".")[0]}-gds-photo.jpg`, { type: TOOL_CONFIG.format });
  ...
  return (
    <main className="min-h-screen">
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-3 gap-4 pt-4">
              ...
              <div className={`p-4 rounded-xl border ${TOOL_CONFIG.colorBorder} ${TOOL_CONFIG.colorBg}`}>
                ...
                <p className={`text-xl font-bold ${TOOL_CONFIG.colorText}`}>4:5 Portrait</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="relative z-10 space-y-6">
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <h2 className="font-heading text-2xl font-bold">Upload Your Photo</h2>
                  </div>
                </div>
      ...
      <SuccessPopup
        ...
        message="Your India Post photo now matches profile-ready dimensions and compression targets."
