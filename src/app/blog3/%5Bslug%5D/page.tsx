    ...
    <div className="min-h-screen bg-[#07090f]">
      ...
      <header className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 relative">
          <Link href="/blog3" className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-white/20 hover:text-brand-orange transition-colors mb-12">
