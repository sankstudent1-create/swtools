          ...
          <div className="max-w-3xl">
            <div className="flex items-center gap-2 mb-6">
              <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-brand-orange/10 border border-brand-orange/20">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-brand-orange">The Chronicle</span>
              </div>
            </div>
            <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-white italic leading-tight mb-6">
              THE <span className="bg-gradient-to-r from-brand-orange to-indigo-400 bg-clip-text text-transparent underline decoration-brand-orange/20">STORIES</span>
            </h1>
            <p className="text-xl text-white/40 font-medium leading-relaxed max-w-2xl italic">
              Stories built to last. Our resilient media architecture ensures every artwork, video, and insight stays perfect forever.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          {featured && (
            <div className="mb-24">
              ...
              <Link href={`/blog/${featured.slug}`} className="group block relative rounded-[40px] overflow-hidden border border-white/5 bg-white/[0.02] hover:border-brand-orange/20 transition-all duration-700">
          ...
          {publishedPosts.length === 0 && (
            <div className="text-center py-40 bg-white/[0.01] border border-dashed border-white/5 rounded-[40px]">
              ...
              <p className="text-[10px] font-bold text-white/10 uppercase tracking-widest mt-2">Publish your first story to begin</p>
            </div>
          )}
        </div>
      </section>
