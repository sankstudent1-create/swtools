...
export const DEFAULT_FORM: LetterForm = {
  ...
  pin: '110 001',
  ph: '011-23096000',
  em: 'directorpost@indiapost.gov.in',
  ...
  sh: '',
  sc: '',
  fno: 'F.No.38-0112013-PAP',
  dt: '',
  toD: 'The Chief Post Master General',
  toA: 'Maharashtra Circle,\nMumbai-400 001.',
  sub: 'Disbursement of Salary/wages/pension to Central Government Employees',
  ref: '',
  sal: 'Sir',
  cls: 'Yours faithfully',
  body: `I am directed to forward herewith a copy of the OM No. 03002(2)/1/2020/TA-II/405 dated 20.08.2020, received from Office of the Controller General of Accounts, Department of Expenditure, Ministry of Finance, wherein the Central Government Offices have been requested that in view of the Ganapati festival, the salary for the month of August, 2020 may be drawn and disbursed to all the Central Government Employees on 27.08.2020 (Thursday).

2.      Office of the Chief Postmaster General, Maharashtra Circle, Mumbai is requested to release the pay and allowances for the month of August, 2020 in respect of all Postal Staff on 27.08.2020 in view of the Ganapati festival.

Yours faithfully,`,
  encl: 'Encl.: As above.',
  copyTo: [
    'The Director of Accounts Postal, Nagpur.',
    'Director of P&T Audit, Mumbai.',
    'Finance Advice Section, Dak Bhavan, New Delhi.',
    '4-6. Guard file / Sanction file / Office copy.',
  ],
  endorsement: '1. Director, Postal Services (HQ)\n2. PS to PMG / CPMG\n3. Guard File',
};
