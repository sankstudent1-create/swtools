...
<div class="pdf-page">
  ...
  ${UV('','left:55.5mm;top:23.5mm;right:12mm;height:5mm',a.name)}
  ...
  ${UV('','left:55.5mm;top:32.0mm;right:12mm;height:5mm',a.desig)}
  ...
  ${UV('','left:141.5mm;top:40.5mm;right:12mm;height:5mm',l.leaveType)}
  ...
  ${UV('','left:91.5mm;top:48.5mm;right:12mm;height:5mm',d.dateStr)}
  ...
  ${UV('','left:116.5mm;top:61.5mm;right:12mm;height:5mm',l.ground)}
  ...
  ${UV('','left:79.5mm;top:71.5mm;right:12mm;height:5mm', addrLines[0] || '')}
  ${UL('left:19mm;top:87.5mm;right:11.5mm')}
  ${UV('','left:19.5mm;top:81.5mm;right:12mm;height:5mm', addrLines[1] || '')}
  ...
  ${UV('','left:110.5mm;top:91.5mm;right:12mm;height:5mm', d.subLine1)}
  ${UL('left:19mm;top:107.5mm;right:11.5mm')}
  ${UV('','left:19.5mm;top:101.5mm;right:12mm;height:5mm', s.address)}
  ...
  <div class="ulv" style="left:33mm;top:156.5mm;font-size:12pt;max-width:60mm;height:5mm;display:flex;align-items:flex-end;">${a.station}</div>
  ${T('left:11.5mm;top:165mm','sz12','Date &nbsp;&nbsp;&nbsp;&nbsp; :')}
  <div class="ulv" style="left:31mm;top:162.5mm;font-size:12pt;height:5mm;display:flex;align-items:flex-end;">${d.appDateFormatted}</div>
  ...
  ${UV('','left:60.5mm;top:250.2mm;width:81mm;height:5mm', a.name)}
  ...
  ${UV('','left:60.5mm;top:255.7mm;width:81mm;height:5mm', s.name)}
  ...
  ${UV('','left:47.5mm;top:261.2mm;width:109mm;height:5mm', sn.postmaster)}
