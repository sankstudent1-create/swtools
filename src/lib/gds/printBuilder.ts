...
<div class="pdf-page">
  ...
  ${UV('','left:55.5mm;top:21.5mm;right:12mm;height:5mm',a.name)}
  ...
  ${UV('','left:55.5mm;top:30.0mm;right:12mm;height:5mm',a.desig)}
  ...
  ${UV('','left:141.5mm;top:38.5mm;right:12mm;height:5mm',l.leaveType)}
  ...
  ${UV('','left:91.5mm;top:46.5mm;right:12mm;height:5mm',d.dateStr)}
  ...
  ${UV('','left:116.5mm;top:59.5mm;right:12mm;height:5mm',l.ground)}
  ...
  ${UV('','left:79.5mm;top:69.5mm;right:12mm;height:5mm', addrLines[0] || '')}
  ${UL('left:19mm;top:87.5mm;right:11.5mm')}
  ${UV('','left:19.5mm;top:79.5mm;right:12mm;height:5mm', addrLines[1] || '')}
  ...
  ${UV('','left:110.5mm;top:89.5mm;right:12mm;height:5mm', d.subLine1)}
  ${UL('left:19mm;top:107.5mm;right:11.5mm')}
  ${UV('','left:19.5mm;top:99.5mm;right:12mm;height:5mm', s.address)}
  ...
  <div class="ulv" style="left:33mm;top:154.5mm;font-size:12pt;max-width:60mm;height:5mm;display:flex;align-items:flex-end;">${a.station}</div>
  ${T('left:11.5mm;top:165mm','sz12','Date &nbsp;&nbsp;&nbsp;&nbsp; :')}
  <div class="ulv" style="left:31mm;top:160.5mm;font-size:12pt;height:5mm;display:flex;align-items:flex-end;">${d.appDateFormatted}</div>
